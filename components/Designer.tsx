...
const Designer = () => {
  ...
  useDndMonitor({
    onDragEnd: (event) => {
      ...
      const droppingSidebarBtnElementOverDesigner =
        isDesignerBtnElement && isDroppingOverDesignerElement;

      if (droppingSidebarBtnElementOverDesigner) {
        const type = active.data?.current?.type;
        const newElement =
          FormElements[type as ElementsType].construct(idGenerator());
        ...
        let indexForNewElement = overElementIndex; // assuming the top half
    ...
    >
      ...
      {mouseIsOver && (
        <>
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform animate-pulse ">
